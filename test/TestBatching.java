...
public class TestBatching {
	...
	public void basicBatching() throws Exception {
		StaticShopExperiment m = TestStaticInsts.createTstModel(new File("testInstances/batch03x02.txt"),
	...
	public void incompatibleJobs() throws Exception {
		StaticShopExperiment m = TestStaticInsts.createTstModel(new File("testInstances/batchIncomp1.txt"),
				new FCFS().setFinalTieBreaker(new TieBreakerFASFS()));
		m.runExperiment();
		double simTime = (Double) m.getResults().get("simTime");
