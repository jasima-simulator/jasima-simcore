...
public class TestQStats {
	...
	public void testNoop() throws MightBlock {
		...
		checkMinMaxMeanCount(stats, 2, 0.0, 0.0, 0.0);
	...
	public void testAverageInv() throws MightBlock {
		...
		checkMinMaxMeanCount(stats, 2+1, (0.0*100.0+1.0*100.0)/200.0, 0.0, 1.0);
	...
	public void testCreationDuringSim2() throws MightBlock {
		...
		checkMinMaxMeanCount(stats, 2, (1.0*100.0)/100.0, 1.0, 1.0);
	...
	public void testStats() throws MightBlock {
		...
		checkMinMaxMeanCount(stats, 3+2, (0.0*1.0+1.0*2.0+2.0*1.0)/4.0, 0.0, 2.0);

		assertEquals("last value", 1.0, stats.lastValue(), 1e-6);
	}

	private static void checkMinMaxMeanCount(SummaryStat stats, int numObs, double mean, double min, double max) {
